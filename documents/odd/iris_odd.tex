...
(ii) inactive, (iii) engorged and (iv) late engorged. Hence, in total there are 12 tick cohorts present in the model. Grid cells serve as habitat for
...
% ~\parencite{Brugger.2009}
% Temp_downscaled  = (T - i) / s
% fit_mean <- lm(mean_temp_gerics ~ 1, offset = mean_temp_dwd, data = calibration_data)
