...
\tiny{FREEZING\_MIN\_TEMP\_WITHOUT\_SNOW}	   	&   -18.9    	& °C &  ~\cite{Gray.2009}		\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\tiny{ACTIVATION\_NECESSARY\_MAXIMAL\_MAX\_TEMP}	& 35.0  & °C & float & ~\cite{Gray.2016, MacLeod.1935} \\
...
\tiny{ACTIVATION\_OPTIMAL\_MAXIMAL\_MEAN\_TEMP}	& 20.0 	& °C & float & ~\cite{Kubiak.2006}		\\
\midrule
