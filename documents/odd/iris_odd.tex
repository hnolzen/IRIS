...
\multirow{11}{*}{\footnotesize{TickAbundance}} & \footnotesize{LARVAE\_QUESTING}	& int & $\mathbb{N}$ & \footnotesize{No. of questing larvae} \\
							& \footnotesize{NYMPH\_QUESTING}	& int & $\mathbb{N}$ & \footnotesize{No. of questing nymphs} \\
							& \footnotesize{ADULT\_QUESTING}	& int & $\mathbb{N}$ & \footnotesize{No. of questing adults} \\
