...
This sub model is implemented in the method \textit{development()} in the class \textit{TickLifeCycle.java}.
...
This sub model controls the desiccation of ticks. It is implemented in the method \textit{desiccation()} in the class \textit{TickLifeCycle.java}.
